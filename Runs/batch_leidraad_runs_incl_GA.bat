...
call :do_runfile LN_GA_02
call :do_runfile LN_B_variant
call :do_runfile LN_0BCM
...
"%exe_path%" /L"%log_dir%\KVK.txt" %FLAGS%  "%prj_dir%\Runs\Runfile.dms" /Vergelijking/Outputs/KostenVerschilAnalyse20/export_csv/result || call :error_handler
